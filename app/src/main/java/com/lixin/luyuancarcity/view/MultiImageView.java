...
import com.lixin.luyuancarcity.utils.DensityUtil;
import com.lixin.luyuancarcity.utils.ImageManager;
import com.lixin.luyuancarcity.weight.ColorFilterImageView;
...
public class MultiImageView extends LinearLayout {
    ...
    private ImageView createImageView(int position, final boolean isMultiImage) {
        ...
        ImageManager.imageLoader.displayImage(url,imageView,ImageManager.options3);
