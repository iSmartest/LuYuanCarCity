...
public class PraiseListView extends TextView{
    ...
    private List<ForumBean.fateList.fateZanList> datas;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.transparent));
    ...
    public List<ForumBean.fateList.fateZanList> getDatas() {
        return datas;
    }
    public void setDatas(List<ForumBean.fateList.fateZanList> datas) {
        this.datas = datas;
    ...
    public void notifyDataSetChanged(){
        ...
        if(datas != null && datas.size() > 0){
            ...
            ForumBean.fateList.fateZanList item = null;
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(MyApplication.getContext(), R.drawable.zan_yes, DynamicDrawableSpan.ALIGN_BASELINE),
