...
import com.lixin.luyuancarcity.bean.ImageTitleBean;
...
//                        load(imageTitleBeanList.get(count - 1).getImageUrl()).into(ivImage);
                ImageManager.imageLoader.displayImage(imageTitleBeanList.get(count - 1).getImageUrl(),ivImage,ImageManager.options3);
...
//                        load(imageTitleBeanList.get(0).getImageUrl()).into(ivImage);
                ImageManager.imageLoader.displayImage(imageTitleBeanList.get(0).getImageUrl(),ivImage,ImageManager.options3);
                tvTitle.setText(imageTitleBeanList.get(0).getTitle());
            } else {
//                Glide.with(context).
//                        load(imageTitleBeanList.get(i - 1).getImageUrl()).into(ivImage);
                ImageManager.imageLoader.displayImage(imageTitleBeanList.get(i - 1).getImageUrl(),ivImage,ImageManager.options3);
