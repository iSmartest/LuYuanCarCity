...
public class NotUsedAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.mReduction = (TextView) convertView.findViewById(R.id.text_item_not_used_coupon_securities_reduce_price);
            viewHolder.mAllPrice = (TextView) convertView.findViewById(R.id.text_item_not_used_coupon_securities_all_price);
            viewHolder.mTime = (TextView) convertView.findViewById(R.id.text_item_not_used_coupon_securities_time);
            viewHolder.mImmediateUse = (TextView) convertView.findViewById(R.id.text_item_not_used_coupon_immediate_use);
        ...
        viewHolder.mTime.setText("温馨提示：(有效期至：" + securitiesList.getSecuritiesTimeZone() + ")");
        return convertView;
    }
    class ViewHolder{
