...
public class UsedAdapter extends BaseAdapter {
    ...
    if (convertView == null){
        convertView = LayoutInflater.from(context).inflate(R.layout.item_used_coupon,null);
        viewHolder = new ViewHolder();
        viewHolder.mReduction = (TextView) convertView.findViewById(R.id.text_item_used_coupon_securities_reduce_price);
        viewHolder.mAllPrice = (TextView) convertView.findViewById(R.id.text_item_used_coupon_securities_all_price);
//        viewHolder.mTime = (TextView) convertView.findViewById(R.id.text_item_not_coupon_securities_time);
//        viewHolder.mImmediateUse = (TextView) convertView.findViewById(R.id.text_item_used_coupon_immediate_use);
