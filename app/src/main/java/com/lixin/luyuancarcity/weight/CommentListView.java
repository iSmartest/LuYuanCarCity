package com.lixin.luyuancarcity.weight;
...
import com.lixin.luyuancarcity.spannable.CircleMovementMethod;
import com.lixin.luyuancarcity.spannable.SpannableClickable;
import com.lixin.luyuancarcity.utils.UrlUtils;
...
public class CommentListView extends LinearLayout {
    ...
    private List<ForumBean.fateList.fateCommentList> mDatas;
    ...
    public void setDatas(List<ForumBean.fateList.fateCommentList> datas){
        if(datas == null ){
            datas = new ArrayList<ForumBean.fateList.fateCommentList>();
        }
        mDatas = datas;
        notifyDataSetChanged();
    }

    public List<ForumBean.fateList.fateCommentList> getDatas(){
        return mDatas;
    }
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.praise_item_selector_default));
    ...
    private View getView(final int position){
        ...
        final ForumBean.fateList.fateCommentList bean = mDatas.get(position);
